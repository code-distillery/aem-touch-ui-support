...
/**
 * Copied from org.apache.sling.api.wrappers.impl.MergingValueMap until we can rely on
 * Sling API 2.23.2.
 *
 * TODO: remove once we can rely on Sling API 2.23.2.
 *
...
public class MergingValueMap implements ValueMap {
     ...
     * {@inheritDoc}
     */
    public void putAll(final @NotNull Map<? extends String, ?> properties) {
        throw new UnsupportedOperationException(IMMUTABLE_ERROR_MESSAGE);
    }
